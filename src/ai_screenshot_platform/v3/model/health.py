...
def build_v3_health(model_registry: UiModelRegistry | None = None) -> V3Health:
    ...
    return V3Health(
        ...
        target_window_found=input_gateway.target_window_found,
        target_window_foreground=input_gateway.target_window_foreground,
        current_foreground_window=input_gateway.current_foreground_window,
