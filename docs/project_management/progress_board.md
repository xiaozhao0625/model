...
- P13 已生成四机真实部署 Markdown 文档、生产 env 示例、启动脚本、健康检查脚本、diagnostics 收集脚本和合并版 DOCX 手册。
- 本阶段只交付部署材料，不下载/安装软件，不操作向日葵，不执行真实四机部署。
- P13 手册明确 M0/W1/W2/W3 角色、软件官方入口、启动顺序、smoke test、diagnostics 和验收清单。
- 下一步是否进入真实四机操作，需要用户和架构师按手册人工确认。
